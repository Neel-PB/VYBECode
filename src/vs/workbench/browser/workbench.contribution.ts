	...
	registry.registerConfiguration({
		...
		properties: {
			...
			"workbench.quickOpen.useZeroBasedOffset": {
				...
				description: localize(
					"workbench.quickOpen.useZeroBasedOffset",
					"Controls whether 'Go To' character offset in Quick Open will use zero-based offset (default is one-based).",
				),
				default: false,
			},
			...
			[LayoutSettings.ACTIVITY_BAR_LOCATION]: {
				type: "string",
				enum: ["default"], // VYBE: Only side position - Activity Bar is always on the side
				default: "default",
				markdownDescription: localize(
					{
				...
				enumDescriptions: [
					...
					// VYBE: Top, Bottom, and Hide options removed - Activity Bar is always on the side
				],
			},
